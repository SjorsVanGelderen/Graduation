...
To write interesting software, the programmer must make clever use of the limited processing power available.
Without data structures and algorithms it is impossible to write meaningful and efficient programs. Well-designed data
structures and algorithms are what push the boundaries of the technology that drives video games.
...
\subparagraph{Time and space complexity}
\subparagraph{Asynchronous / concurrent algorithms}
\subparagraph{Divide and conquer}
\subparagraph{Greedy algorithms}
...
% ATTENTION REQUIRED: This graph is not used anywhere in the explanations
\begin{figure}[H]
  \centering
...
\subparagraph{Giuseppe Maggiore, Mohamed Abbadi, Francesco di Giacomo, Giulia Constantini}
